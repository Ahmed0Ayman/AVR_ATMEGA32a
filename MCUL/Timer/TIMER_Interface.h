...
#define		TIM16Bit_MODE_COMP_PWM_FAST_10B								0x13ffu
#define		TIM16Bit_MODE_COMP_PWM_FAST_9B								0x11ffu
#define		TIM16Bit_MODE_COMP_PWM_FAST_8B								0x10ffu
/* Top OCR1x */
...
#define		TIM_COMP_OUT_NormalGPIO						    			0x00u
#define		TIM_COMP_OUT_PIN_TOG						    			0x10u
#define		TIM_COMP_OUT_PIN_CLR						    			0x20u
#define		TIM_COMP_OUT_PIN_SET						    			0x30u
	
	
	
#define		_TIM_IT_EN(INT)								    			TIMSK |= ((uint8_t)INT)
...
typedef enum{ 
		TIM_0_IT_OVER =0x01	, TIM_0_IT_COMP   =0x02	 ,TIM_1_IT_OVER =0x04,											
